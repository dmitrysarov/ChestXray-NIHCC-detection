...
root_path = "/Users/dmitry/Projects/dantiai/test_data"
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_obj=dict(
            type="CrossEntropyLoss", use_sigmoid=True, reduction="sum", loss_weight=1.0, class_weight=[1000]
        ),
...
optim_wrapper = dict(
    ...
    optimizer=dict(type="SGD", lr=base_lr, momentum=0.9, nesterov=True),
